...
schemaBuilder.buildDist({
  ...
  taginfoProjectInfo: {
    ...
    description:
      "Presets available in the iD editor, Rapid, StreetComplete, Go Map!!, Every Door, and other applications",
    project_url: "https://github.com/openstreetmap/id-tagging-schema/",
    icon_url:
      "https://cdn.jsdelivr.net/gh/openstreetmap/iD@release/dist/img/logo.png",
